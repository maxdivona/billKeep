...
if (fs.existsSync(bundleDir)) {
  ...
  try {
    ...
    if (copiedFiles.length === 0) {
      console.log(
        '⚠️ Nessun pacchetto (deb, appimage, ecc.) trovato in src-tauri/target/release/bundle/.'
      )
    } else {
  ...
  console.log(
    '⚠️ Cartella bundle non trovata. Assicurati che tauri build sia stato completato con successo.'
  )
}
