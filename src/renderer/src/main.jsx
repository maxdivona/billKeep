...
window.api = {
  ...
  getInvoicesPaginated: (filters) =>
    invoke('get_invoices_paginated', {
      limit: filters.limit,
  ...
  getPaymentsPaginated: (filters) =>
    invoke('get_payments_paginated', {
      limit: filters.limit,
      offset: filters.offset,
      search: filters.search || null
    }),
  ...
  getJournalEntries: (filters) =>
    invoke('get_journal_entries', { customerId: filters?.customerId || null }),
  getJournalEntriesPaginated: (filters) =>
    invoke('get_journal_entries_paginated', {
      limit: filters.limit,
      offset: filters.offset,
      search: filters.search || null,
