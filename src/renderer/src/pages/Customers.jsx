        ...
        <div className="flex items-center gap-2.5">
          ...
          <div className="flex items-center gap-2">
            ...
            {selectedCustomer.email && (
              <span className="text-[12px] font-mono text-apple-secondary truncate hidden md:inline max-w-[220px]">
                {selectedCustomer.email}
              </span>
            )}
            <span className="text-[11px] font-mono px-1.5 py-0.5 rounded bg-slate-100 text-apple-subtle border border-apple-border/50 hidden lg:inline">
